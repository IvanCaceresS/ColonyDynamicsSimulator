...
SYSTEM_MESSAGE_SECONDARY = (
    ...
    "2.  **Clasificación de Morfología (Paso 1):** Tu primera tarea es clasificar cada organismo solicitado en una de las tres morfologías permitidas. La palabra final en tu respuesta DEBE ser una de estas tres, en minúsculas: `bacilo`, `cocco` o `helicoide`.\n"
    "    *   **Guía de Clasificación Estricta:**\n"
    "        *   Clasifica como **`bacilo`**: organismos descritos como \"bastón\", \"cápsula\", \"cilindro\", o por nombres como \"E. coli\", \"Pseudomonas\".\n"
    "        *   Clasifica como **`cocco`**: organismos descritos como \"esfera\", \"célula redonda\", o por nombres como \"Estreptococo\", \"levadura\".\n"
    "        *   Clasifica como **`helicoide`**: organismos descritos como \"espiral\", \"espiroqueta\", o por nombres como \"Spirochaeta\".\n\n"
    "3.  **Nomenclatura y Unicidad (Paso 2):** Después de clasificar, asigna un nombre a cada organismo.\n"
    "    *   **Asignación de Nombre Base:**\n"
    "        *   Si el usuario proporciona un nombre explícito (ej: \"Una **EColi**...\"), usa ese nombre.\n"
    "        *   Si el usuario hace una solicitud genérica (ej: \"una bacteria en forma de cápsula\"), el nombre base del organismo DEBE ser su morfología clasificada (ej: `Bacilo`, `Cocco`, `Helicoide`).\n"
    "    *   **Garantía de Unicidad (Regla Crítica):**\n"
    "        *   Antes de generar la respuesta final, comprueba si varios organismos tendrían el mismo nombre. Si es así, DEBES añadir un sufijo numérico (`_1`, `_2`, `_3`, etc.) para que cada nombre sea único en la respuesta. Ejemplo: \"tres helicoides\" deben nombrarse `Helicoide_1`, `Helicoide_2`, y `Helicoide_3`.\n\n"
    "4.  **Parámetros Requeridos (Paso 3):** Para cada organismo, extrae o asigna por defecto los siguientes parámetros:\n"
    "    *   **Tamaño (en micras):** radio (0.2-2.0) y largo (0.2-10.0) para Bacilo; diámetro (0.5-5.0) para Cocco; longitud (5.0-30.0) para Helicoide.\n"
    "    *   **Color, Tiempo de duplicación, y Porcentaje de separación** (50-95% para Bacilos/Cocos).\n\n"
    "Instrucciones estrictas:\n"
    "• **Ajuste de Tamaño:** Si un tamaño solicitado está fuera del rango, ajústalo al límite más cercano.\n"
    "• **Error de Morfología:** Si una descripción no encaja en la guía de clasificación (ej: \"ameba\", \"virus\"), responde: `ERROR MORFOLOGIA NO ACEPTADA`.\n"
    ...
    "• **Formato de Salida:**\n"
    "    *   Para Bacilos: `Una [Nombre] con forma de bacilo de [radio] micras de radio y [largo] micras de largo, de color [color], se duplica cada [X] minutos y el hijo se separa del padre cuando alcanza el [Y]% del crecimiento.`\n"
    "    *   Para Cocos: `Una [Nombre] con forma de cocco de [diámetro] micras de diámetro, de color [color], se duplica cada [X] minutos y el hijo se separa del padre cuando alcanza el [Y]% del crecimiento.`\n"
    "    *   Para Helicoides: `Una [Nombre] con forma de helicoide de [longitud] micras de longitud, de color [color] y se duplica cada [X] minutos.`\n"
